...
HPGL er et dataformat, som indeholder adskillige forskellige instruktioner med forskellige parametre (se afsnit \titleref{sc:idn-ins-param})
. Vi benytter os ikke af samtlige instruktioner, men blot et lille udvalg med udgangspunkt i vores kravspecifikation.
I projektet anvender vi følgende instruktioner:

\begin{itemize} \firmlist
\item \texttt{PU/PD - Pen Up/Pen Down. Bruges til at hæve og sænke pennen.}
\item \texttt{PA/PR - Plot Absolut/Plot Relativ. Se afsnit \titleref{sc:relativ-absolut}}
\item \texttt{CI - Plot Circle. Se afsnit \titleref{sc:matematik-cirkel}}
\end{itemize}

HPGL bruger oprindeligt bogstaver, tal og symboler (komma, punktum osv.) til at identificere instruktioner,
men som det fremgår af næste afsnit, så anvender vi kun bogstaver i vores identifikation.
