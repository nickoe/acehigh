...
Eget format \\\midrule
{\begin{itemize}
\item Vi kan gøre det så simpelt som muligt, både til at læse og til at forstå
\end{itemize}}
&
{\begin{itemize}
\item Det vil nok afføde børnesygdomme
\item Der findes ikke software, som kan håndtere vores dataformat
...
&
{\begin{itemize}
\item Niveauet er sat højt, hvilket betyder, at der er mange funktioner som vi ikke får brug for
