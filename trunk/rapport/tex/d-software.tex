...
Den mindst mulige positionsændring er ét skridt med stepmotoren og
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.8\textwidth]{./img/motorstyring-indlagt-forsinkelse-vs2}
  \caption{Motorstyring med indlagt forsinkelse.}
  \label{fig:motorstyring-indlagt-forsinkelse}
\end{figure}
\fixme{anden skitse}

Ved denne type motorstyring er tiden $\Delta t$ mellem
skridtene\fixme{fælles: andet ord?} givet ved
(sætning~\ref{eq:afbrudt-afvikling-tid})
\begin{align}
...
afviklingstidspunktet. Metoden upræcis ved høje
...
Med denne metode kendes mindst mulige forsinkelse $t$ ($t$ er den
reciprokke frekvens vi kalder tjekkeralgoritmen\fixme{korrektur} med),
og vi har, hvad vi efterspørger. Forskellige hastigheder opnås ved at
undlade at flytte motorerne på alle tidspunkter (se
...
\end{figure}
\fixme{er det ikke implementering?}
