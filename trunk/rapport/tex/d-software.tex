...
\Cpp-speficikke elementer (f.eks. generisk programmering\fixme{nick:
  note om dette?}). Moduler, der afhænger af moduler skrevet i \Cpp,
vil typisk også være skrevet i \Cpp.
...
undgået (\fixme{nick: eksempler her!}). \Cpp\ bruges ikke objektorienteret.
